...
const iptvFranceFaqs = [
  ...
  { q: "Combien coûte un abonnement IPTV en France ?", a: "Chez France IPTV, de 8 € pour 1 mois à 45 € pour 12 mois, sans reconduction automatique, avec un test gratuit de 24 h sur demande." },
];
