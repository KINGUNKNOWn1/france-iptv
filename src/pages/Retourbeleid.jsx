              ...
              >
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4 border border-brand-gray-border">
                    ...
                    <p className="text-brand-gray text-sm">Non, mais nous nous engageons à résoudre le problème via notre support 24/7. En cas de problème durable de notre côté, nous proposons une compensation sous forme de prolongation de durée.</p>
                  </div>
