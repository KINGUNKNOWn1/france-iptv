        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
              ...
              {/* Guarantee: first month, 48 h */}
              <div id="garantie-48h" className="bg-brand-offwhite border-2 border-brand-gold/60 rounded-2xl p-8 scroll-mt-24">
                <h2 className="text-2xl font-bold mb-4 text-brand-black">Garantie Satisfait ou Remboursé 48 h (1er mois)</h2>
                <p className="text-brand-gray leading-relaxed mb-4">
                ...
                <ul className="space-y-2 text-brand-gray mb-4">
                  ...
                  <li className="flex items-start gap-2"><span className="text-green-500 mt-1">✓</span><span>La demande doit être faite dans les <strong className="text-brand-black">48 heures suivant l'activation</strong>, par WhatsApp ou par e-mail à support@franceiptv.stream.</span></li>
              ...
              >
                ...
                <ul className="space-y-2 text-brand-gray">
                  <li className="flex items-start gap-2">
                    ...
                    <span>L'abonnement est déjà activé et vous avez eu accès au service (sauf garantie 48 h sur le 1er mois, voir plus haut)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 mt-1">✗</span>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4 border border-brand-gray-border">
                    ...
                    <p className="text-brand-gray text-sm">Pour une première commande d'un mois, oui : la garantie satisfait ou remboursé 48 h s'applique. Pour les autres commandes, nous nous engageons à résoudre le problème via notre support 24/7. En cas de problème durable de notre côté, nous proposons une compensation sous forme de prolongation de durée.</p>
                  </div>
