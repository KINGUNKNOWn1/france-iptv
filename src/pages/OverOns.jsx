...
const OverOns = () => {
  ...
  const stats = [
    ...
    { number: "24 h", label: "Satisfait ou remboursé" }
  ];
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                    <div className="text-brand-gray">
                      <strong className="text-brand-black">Meilleur Prix :</strong> 8 € pour 1 mois, 45 € pour 12 mois. Aucun frais caché,
                ...
                <div className="bg-surface border border-brand-gold/40 p-8 rounded-xl">
                  <ul className="space-y-4 text-white/95">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      <span>1er mois satisfait ou remboursé 24 h</span>
                    </li>
                    <li className="flex items-center gap-3">
        ...
        <section className="py-20 bg-gradient-to-br from-surface to-brand-offwhite">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-xl text-brand-gray mb-8">
              Commencez pour 8 €, satisfait ou remboursé 24 h. Découvrez par vous-même pourquoi nous sommes le{' '}
            ...
            <p className="text-sm text-brand-gray mt-6">
              ✅ Satisfait ou remboursé 24 h • 📺 4 écrans simultanés • 🇫🇷 100 % Francophone
            </p>
          </div>
        </section>
      </div>
