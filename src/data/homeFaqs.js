// Homepage FAQ: rendered on the page and used for its FAQPage JSON-LD, so the
// visible answers and the structured data can never drift apart.
export const homeFaqs = [
  { q: 'Comment démarrer avec France IPTV ?', a: "C'est très simple ! Contactez-nous via WhatsApp, choisissez votre forfait, payez en toute sécurité par Binance Pay ou PayPal, et recevez vos identifiants sous 5 minutes. Vous pouvez alors commencer à regarder immédiatement sur tous vos appareils." },
  { q: "Sur combien d'appareils puis-je regarder en même temps ?", a: 'Avec tous nos forfaits, vous pouvez regarder sur 4 appareils maximum simultanément. Parfait pour toute la famille ! Chaque écran reçoit la même qualité élevée.' },
  ...
  { q: "Puis-je tester avant de m'engager ?", a: "Oui : le 1er mois coûte 8 € et il est satisfait ou remboursé pendant 24 h. Si le service ne vous convient pas, écrivez-nous dans les 24 h qui suivent l'activation et vous êtes remboursé intégralement." },
