        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Aucun boîtier IPTV supplémentaire nécessaire.
              <br />
              <span className="bg-gradient-to-r from-brand-gold to-orange-500 bg-clip-text text-transparent">
                Compatible avec vos appareils actuels.
              </span>
            </h2>

            <div className="space-y-5 text-gray-600 text-lg mb-10 leading-relaxed">
              <p>
                Avec un abonnement France IPTV, vous choisissez vous-même l'appareil sur lequel regarder : votre Samsung ou LG Smart TV, votre iPhone ou téléphone Android, votre ordinateur portable ou Amazon Fire TV Stick. <span className="font-semibold text-gray-800">Aucun matériel supplémentaire ni connaissance technique requise.</span>
              </p>
              <p>
                Installez IPTV Smarters Pro ou SS IPTV, saisissez vos identifiants et c'est prêt ! <span className="font-semibold text-gray-800">En moyenne, vous regardez votre première chaîne en cinq minutes.</span>
              </p>
              <p>
                Vous préférez acheter un abonnement IPTV avec un boîtier externe pour une connexion 4K plus stable ? C'est possible. Amazon Fire TV Stick, Formuler Z11 et Xsarius sont compatibles. <span className="font-semibold text-gray-800">Nous vous conseillons gratuitement via WhatsApp</span> sur le boîtier le plus adapté à votre téléviseur et votre connexion internet.
              </p>
            </div>
            ...
            <div className="mb-10">
              <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-5 flex items-center gap-2">
                <div className="w-8 h-0.5 bg-gradient-to-r from-brand-gold to-orange-500" />
            ...
            >
              ...
              <div>
                <p className="font-bold text-gray-900 text-lg">Actif en 5 minutes</p>
                <p className="text-sm text-gray-600">Aucun matériel supplémentaire requis</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <img
loading="lazy" decoding="async"                   src="https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=1200&q=80"
                  alt="Football à la télévision"
              ...
              <div className="grid grid-cols-3 gap-5">
                ...
                >
                  <img
loading="lazy" decoding="async"                     src="https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=400&q=80"
                    alt="Téléphone"
                ...
                >
                  <img
loading="lazy" decoding="async"                     src="https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&q=80"
                    alt="Tablette"
