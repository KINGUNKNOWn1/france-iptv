      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-2">
            MÉGA RÉDUCTION : Jusqu'à 40% de Réduction !
          </h2>

          <p className="text-white/90 text-lg md:text-xl mb-6 max-w-2xl mx-auto">
            Commandez maintenant et profitez de notre plus grosse réduction jamais proposée. Cette offre se termine dans :
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-2 text-white text-sm">
              <FaClock />
              <span>Plus que {Math.floor(Math.random() * 20) + 10} places disponibles</span>
            </div>
          </div>

          {/* Social Proof */}
          <p className="text-white/80 text-sm mt-6">
            ⭐ 127 personnes ont déjà profité de cette offre aujourd'hui
          </p>
        </motion.div>
      </div>
    </section>
