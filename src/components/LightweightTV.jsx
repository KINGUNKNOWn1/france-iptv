    ...
    <div className="w-full h-[600px] relative overflow-hidden bg-gradient-to-b from-ink to-gray-900">
      ...
      <div className="relative h-full flex items-center justify-center px-8">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 shadow-2xl">
            {/* Screen glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-brand-gold/20 to-blue-500/20 rounded-3xl blur-xl" />
      ...
      >
        <div className="bg-surface-2/90 backdrop-blur-md border border-brand-gold/30 rounded-2xl p-6 shadow-xl">
          ...
          <h3 className="text-2xl font-bold text-white">30 500+ Chaînes</h3>
          <p className="text-gray-400">Regardez sur tous vos appareils</p>
        </div>
      </motion.div>
    </div>
  );
