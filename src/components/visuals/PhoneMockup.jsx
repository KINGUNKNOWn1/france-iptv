    ...
    >
      ...
      <g filter="url(#phoneShadow)">
        ...
        <g clipPath="url(#phoneClip)">
          ...
          <rect x="30" y="55" width="240" height="60" fill="#33518C"/>
          ...
          {/* Play Button */}
          <circle cx="150" cy="205" r="30" fill="#33518C" opacity="0.9"/>
          ...
          <g transform="translate(45, 295)">
            {[0, 1, 2, 3].map((i) => (
              <g key={i} transform={`translate(0, ${i * 60})`}>
                ...
                <rect x="10" y="10" width="40" height="30" rx="4" fill={i % 2 === 0 ? "#33518C" : "#0066CC"}/>
      ...
      <defs>
        ...
        <linearGradient id="videoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#33518C"/>
