...
function GradientPlane() {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Brand colors: orange #33518C and blue
  ...
  return (
    <div className="absolute inset-0 -z-10 opacity-30">
      ...
      >
        ...
        <pointLight position={[5, 5, 5]} intensity={1} color="#33518C" />
        <pointLight position={[-5, -5, 0]} intensity={0.8} color="#3b82f6" />

        {variant === 'hero' && (
          <>
            <AnimatedSphere position={[-3, 0, -2]} color="#33518C" speed={0.5} distort={0.6} />
        ...
        {variant === 'minimal' && (
          <AnimatedSphere position={[0, 0, -3]} color="#33518C" speed={0.4} distort={0.3} />
        )}
      </Canvas>
    </div>
  );
